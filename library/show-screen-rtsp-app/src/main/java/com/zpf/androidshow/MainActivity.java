...
public class MainActivity extends Activity implements View.OnClickListener{
        ...
        public void onError(RtspServer server, Exception e, int error) {
            ...
            if (error == RtspServer.ERROR_BIND_FAILED) {
                new AlertDialog.Builder(MainActivity.this)
                        .setTitle(getString(R.string.error_port_unavailable_title))
                        .setMessage(getString(R.string.error_port_unavailable_message))
                        .show();
            }
        }
        ...
        public void onMessage(RtspServer server, int message) {
            if (message==RtspServer.MESSAGE_STREAMING_STARTED) {
                runOnUiThread(new Runnable() {
                    public void run() {
                        Toast.makeText(MainActivity.this, R.string.notice_rtsp_stream_started, Toast.LENGTH_SHORT).show();
                    }
                });
            } else if (message==RtspServer.MESSAGE_STREAMING_STOPPED) {
                runOnUiThread(new Runnable() {
                    public void run() {
                        Toast.makeText(MainActivity.this, R.string.notice_rtsp_stream_stopped, Toast.LENGTH_SHORT).show();
                    }
                });
            }
        }
    ...
    private void StartScreenCapture(){
        if(RtspAddress != null && !RtspAddress.isEmpty()){
            ...
            Toast.makeText(MainActivity.this, R.string.error_rtsp_server_endpoint, Toast.LENGTH_SHORT).show();
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data){
        try {
            ...
            if(mediaProjection == null){
                Toast.makeText(MainActivity.this, R.string.error_media_projection, Toast.LENGTH_SHORT).show();
                return;
            }
